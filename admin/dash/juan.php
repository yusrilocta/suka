...
$result = $conn->query($sql);
    ...
    <div class="container mt-5">
        <form action="pros_input_sisa.php" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" class="form-control" id="jumlah_dpt" name="handle" value="<?php echo $gg ?>" required>
            <div class="form-group">
                <label for="jumlah_dpt">Jumlah DPT:</label>
                <input type="number" class="form-control" id="jumlah_dpt" name="dpt" value="<?php echo $dpt ?>" required>
            </div>
            <div class="form-group">
                <label for="jumlah_dptb">Jumlah DPTB:</label>
                <input type="number" class="form-control" id="jumlah_dptb" name="dptb" value="<?php echo $dptb ?>" required>
            </div>
            <div class="form-group">
